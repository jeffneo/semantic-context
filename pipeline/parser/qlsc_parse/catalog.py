...
The snapshot is produced by pipeline/extract.py from INFORMATION_SCHEMA. It holds
names, types, partitioning and view SQL - never descriptions or constraints.
"""
...
class Catalog:
    def __init__(self, data: dict, rules: list[dict] | None = None):
        ...
        self.schema = MappingSchema(nested, dialect="bigquery")
